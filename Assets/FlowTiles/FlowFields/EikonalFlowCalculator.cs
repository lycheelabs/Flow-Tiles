...
namespace FlowTiles.FlowFields {
    ...
    [BurstCompile]
    public struct EikonalFlowCalculator {
        ...
        [BurstCompile]
        public static void BurstCalculate (ref EikonalFlowCalculator calculator) {
        ...
        public EikonalFlowCalculator(CostMap sector, CellRect goalBounds, int2 exitDirection) {
